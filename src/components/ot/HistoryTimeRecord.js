...
export default class HistoryTimeRecord extends React.Component {

    render() {
        return(
            <Card style={[styles.cardContainer]}>
                    <CardItem style={styles.cardContainer2}>
                    <Text style={styles.titleText}>ประวัติการลงเวลา</Text>
                    ...
                    <TouchableOpacity style={styles.card}>
                      ...
                      <View style={styles.circle2}>    
                        <View style={styles.circle}>
                            ...
                            <Text style={styles.litelText}>ขาด</Text>  
                        </View>
                        </View>
                        </View>
                   ...
                   <TouchableOpacity style={styles.card}>
                    ...
                    <View style={styles.circle2}> 
                      <View style={styles.circle}>                                         
                          <Text style={styles.noteText2} >14</Text>
                          <Text style={styles.litelText}>มาสาย</Text>                  
                      </View>
                      </View>
                      </View>
                      <View style={styles.square}/>
                    ...
                    <View style={styles.circle2}>
                      <View  style={styles.circle}>          
                          <Text style={styles.noteText2}>2</Text>
                          <Text style={styles.litelText}>กลับก่อน</Text>                      
                      </View>
                      </View>
                      </View>
                      <View style={styles.square}/>
