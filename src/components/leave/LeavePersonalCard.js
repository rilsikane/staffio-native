    ...
    return (
        ...
        (
            ...
            <Card style={{marginBottom:0}}>
                ...
                <CardItem style={{paddingLeft:responsiveWidth(1.5),paddingRight:responsiveWidth(1.5), borderLeftWidth:responsiveWidth(2.5),flex:3,borderLeftColor:this.props.info.color}}>
                    ...
                    <Body style={{flex:4}}>
                        <View style={{flexDirection: 'row', alignItems:'center'}}>
                            ...
                            {(<Text ellipsizeMode='tail' numberOfLines={1} style={{fontFamily: 'Kanit-Medium', color:'#fbaa3e',flex:2, fontSize:responsiveFontSize(1.8)}}>{this.props.info.createDate}</Text>)}
                            {(<Text ellipsizeMode='tail' numberOfLines={1} style={{fontFamily: 'Kanit-Medium', color:this.props.info.color,flex:1.3, fontSize:responsiveFontSize(1.8)}}>{this.props.info.type}</Text>)}
                        ...
                        <View style={{flexDirection: 'row', alignItems:'center',paddingTop:5}}>
                            ...
                            {(<Text ellipsizeMode='tail' numberOfLines={1} style={{fontFamily: 'Kanit-Medium', color:'#fbaa3e',flex:2, fontSize:responsiveFontSize(1.8)}}>{this.props.info.requestStatus}</Text>)}                         
                        </View>
                    </Body>
                </CardItem>
                {/* </View> */}
