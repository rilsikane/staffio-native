        ...
        // (        
            <Card style={{marginBottom:0}}>
                ...
                <CardItem style={{paddingRight:responsiveWidth(1.5),flex:3}}>
                    <TouchableOpacity style={{flex:1,marginLeft:-responsiveWidth(3)}} onPress={() => this.props.onSelect(this.props.info.index)} >
                        <Left style={{backgroundColor:'transparent',alignItems:'center'}}>
                    ...
                    <TouchableOpacity style={{flex:4}} onPress={() => this.props.openDetail(this.props.info)}>
                        <Body>
