            ...
            <Card style={{marginBottom:0}}>
                <CardItem style={{paddingLeft:5,paddingRight:5}}>
                    ...
                    <Body style={{flex:4}}>
                        ...
                        <View style={{flexDirection: 'row', alignItems:'center',paddingTop:5}}>
                            {(<Text style={{fontFamily:'Kanit-Medium', color:'#7e6560',flex:0, fontSize:responsiveFontSize(1.5),textAlign:'center'}}>{I18n.t('Since')}</Text>)}
                            ...
                            {(<Text style={{fontFamily:'Kanit-Medium', color:'#7e6560',flex:0, fontSize:responsiveFontSize(1.5),textAlign:'center'}}>{I18n.t('To')}</Text>)}
