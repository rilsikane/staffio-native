                    ...
                    <CardItem style={{backgroundColor: '#FBCB8D', height: responsiveHeight(2),flex:3, width: responsiveWidth(50)}}>
                        <Body style={{flex:4}}>
                            <View style={{flexDirection: 'row', alignItems:'center'}}>
                                {(<Text style={{paddingBottom: 2, fontFamily:'Kanit-Medium', color:'#7e6560',flex:4, fontSize:responsiveFontSize(2),textAlign:'center'}}>ขอยกเลิกรายการ</Text>)}
                        </View>
                        </Body>
                    </CardItem>
                </View>
                ...
                <CardItem style={{paddingLeft:responsiveWidth(1.5),paddingRight:responsiveWidth(1.5), borderLeftWidth:responsiveWidth(2.5),flex:3}}>
                    ...
                    <Body style={{flex:4}}>
                        <View style={{flexDirection: 'row', alignItems:'center'}}>
                            ...
                            {(<Text style={{fontFamily: 'Kanit-Medium',backgroundColor:'#BECC9A',borderRadius: responsiveWidth(2), color:'white',flex:1, fontSize:responsiveFontSize(1.8),textAlign:'center'}}>{`2 วัน`}</Text>)}
                        </View>
