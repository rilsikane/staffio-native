...
export default class ActionButton extends Component {
  ...
  render() {
    return (
      <View
        ...
        style={[this.getOverlayStyles(), this.props.style,{backgroundColor:'transparent'}]}
      >
        <Animated.View
          pointerEvents="none"
          style={[
  ...
  _renderButtonIcon() {
    const { icon, renderIcon, btnOutRangeTxt, buttonTextStyle, IconButton } = this.props;
    ...
    return (
      ...
      >
        {/* {buttonText} */}
        {/* <FontAwesome name={buttonIcon} size={25} style={{ color: 'white' }} /> */}
        {IconButton}
      </Animated.Text>
    );
  }
